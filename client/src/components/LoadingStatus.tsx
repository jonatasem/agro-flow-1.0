...
import type { LoadingStatusProps } from '../interface';

export default function LoadingStatus({ mensagem = "Conectando ao ecossistema Zilor Atlas..." }: LoadingStatusProps) {
  return (
    <div className="flex flex-col items-center justify-center min-h-75 p-8 bg-[#181b26] border border-agro-border/40 rounded-2xl animate-fade-in">
      {/* Ícone giratório usando utilitários nativos do Tailwind */}
